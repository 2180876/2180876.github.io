...
V47 <- rasterGrob(readPNG("/Users/taylorswift/downloads/dissertation/DissdataVIDEOS/V47.png"), interpolate=TRUE)
V48 <- rasterGrob(readPNG("/Users/taylorswift/downloads/dissertation/DissdataVIDEOS/V48.png"), interpolate=TRUE)
# grid.arrange(pre_fig, post_fig, ncol=2)
grid.arrange(V47, V48, ncol=2)
...
P120a <- rasterGrob(readPNG("/Users/taylorswift/downloads/dissertation/DissdataIMAGES/P120a.png"), interpolate=TRUE)
P120b <- rasterGrob(readPNG("/Users/taylorswift/downloads/dissertation/DissdataIMAGES/P120b.png"), interpolate=TRUE)
# grid.arrange(pre_fig, post_fig, ncol=2)
grid.arrange(P120a, P120b, ncol=2)
...
P117 <- rasterGrob(readPNG("/Users/taylorswift/downloads/dissertation/DissdataIMAGES/P117.png"), interpolate=TRUE)
V53 <- rasterGrob(readPNG("/Users/taylorswift/downloads/dissertation/DissdataVIDEOS/V53.png"), interpolate=TRUE)
# grid.arrange(pre_fig, post_fig, ncol=2)
grid.arrange(P117, V53, ncol=2)
